...
## Formulario
Como en la sección anterior, también hice el mismo procedimiento para pasar las regiones y comunas para el prellenado que se realiza en el JS.
